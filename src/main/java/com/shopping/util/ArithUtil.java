...
public class ArithUtil { // 默认除法运算精度
	...
	private static final int DEF_DIV_SCALE_TEN = 20; // 这个类不能实例化
	 ...
	 * @return 两个参数的商
	 */
	public static double divMany(String v1, String v2) {
		return div(v1, v2, DEF_DIV_SCALE_TEN);
	}
	 ...
	 * @see [类、类#方法、类#成员]
	 */
	public static boolean StringCompareDouble(String v1, Double v2) {
		Double double1 = Double.valueOf(v1);
		return double1.compareTo(v2) >= 0;
	}
    ...
    public static void main(String[] args) {
        System.out.println(StringCompareDouble("2.33", 2.32D));
    }
};