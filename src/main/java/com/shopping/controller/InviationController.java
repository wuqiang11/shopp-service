...
public class InviationController {
    ...
    @ResponseBody
    public Tip inviateUserRegister(@Valid InviationRegReqDto reqDto) {
    ...
    @ResponseBody
    public Tip getShareLink(@Valid GetShareLinkReqDto reqDto) {
    ...
    @ResponseBody
    public Tip getLowerUser(@Valid GetLowerUserReqDto reqDto)
    {
